...
const kt = ref(0), mr = ref(1), q = ref({}), te = ref(0), Vt = ref({}), Ae = typeof window > "u";
function so(e, t, r) {
...
const de = {
  ...
  setup(e) {
    ...
    return v.setOnHead((d) => {
      ...
      n.value[v.currentStack.value] && (s.value = false), n.value[v.currentStack.value] = { html: d, type: p }, nextTick(() => {
        s.value = true;
      });
...
function lr({ props: e, attrs: t, slots: r, slot: n, name: i }) {
  ...
  if (n) {
    ...
    for (let [f, d] of Object.entries(n))
      typeof d == "boolean" && (c = true), d === true && h2.push(f);
    c && (u["data-headlessui-state"] = h2.join(" "));
  }
  if (s === "template") {
...
function Ft(e, t, { sorted: r = true, relativeTo: n = null, skipElements: i = [] } = {}) {
  ...
  let l = (() => {
    ...
    if (t & 8)
      return o.length - 1;
    throw new Error("Missing Focus.First, Focus.Previous, Focus.Next or Focus.Last");
  })(), c = t & 32 ? { preventScroll: true } : {}, h2 = 0, f = o.length, d;
  do {
    if (h2 >= f || h2 + f <= 0)
      return 0;
    let p = u + h2;
...
let dt = Object.assign(defineComponent({ name: "FocusTrap", props: { as: { type: [Object, String], default: "div" }, initialFocus: { type: Object, default: null }, features: { type: Number, default: 30 }, containers: { type: Object, default: ref(/* @__PURE__ */ new Set()) } }, inheritAttrs: false, setup(e, { attrs: t, slots: r, expose: n }) {
  ...
  return () => {
    let f = {}, d = { ref: i, onKeydown: c, onFocusout: h$1 }, { features: p, initialFocus: m, containers: g, ...x } = e;
    return h(Fragment, [Boolean(p & 4) && h(gr, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: l, features: jt.Focusable }), z({ ourProps: d, theirProps: { ...t, ...x }, slot: f, attrs: t, slots: r, name: "FocusTrap" }), Boolean(p & 4) && h(gr, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: l, features: jt.Focusable })]);
  };
} }), { features: Ni });
  ...
  return onMounted(() => a.value = true), onUnmounted(() => a.value = false), onMounted(() => {
    watch([t, r, n], (s, o) => {
      ...
      !l || Yl(() => {
        ...
        if (!a.value)
          return;
        let h2 = oe(r), f = (u = e.value) == null ? void 0 : u.activeElement;
        if (h2) {
          if (h2 === f) {
            i.value = f;
            return;
        ...
        h2 ? Qe(h2) : Ft(l, $e.First | $e.NoScroll) === Bi.Error && console.warn("There are no focusable elements inside the <FocusTrap />"), i.value = (c = e.value) == null ? void 0 : c.activeElement;
      });
...
defineComponent({ name: "Description", props: { as: { type: [Object, String], default: "p" }, id: { type: String, default: () => `headlessui-description-${Ue()}` } }, setup(e, { attrs: t, slots: r }) {
  ...
  return onMounted(() => onUnmounted(n.register(e.id))), () => {
    let { name: i = "Description", slot: a = ref({}), props: s = {} } = n, { id: o, ...l } = e, u = { ...Object.entries(s).reduce((c, [h2, f]) => Object.assign(c, { [h2]: unref(f) }), {}), id: o };
...
let _t = "DC8F892D-2EBD-447C-A4C8-A03058436FF4", Yr = defineComponent({ name: "Dialog", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, open: { type: [Boolean, String], default: _t }, initialFocus: { type: Object, default: null }, id: { type: String, default: () => `headlessui-dialog-${Ue()}` } }, emits: { close: (e) => true }, setup(e, { emit: t, attrs: r, slots: n, expose: i }) {
  ...
  let o = ref(0), l = Kr(), u = computed(() => e.open === _t && l !== null ? X(l.value, { [Re.Open]: true, [Re.Closed]: false }) : e.open), c = ref(/* @__PURE__ */ new Set()), h$1 = ref(null), f = ref(null), d = computed(() => at(h$1));
  if (i({ el: h$1, $el: h$1 }), !(e.open !== _t || l !== null))
  ...
  let p = computed(() => s.value && u.value ? 0 : 1), m = computed(() => p.value === 0), g = computed(() => o.value > 1), x = inject(wr, null) !== null, A = computed(() => g.value ? "parent" : "leaf");
  eu(h$1, computed(() => g.value ? m.value : false)), au({ type: "Dialog", enabled: computed(() => p.value === 0), element: h$1, onUpdate: (w, O, $) => {
    if (O === "Dialog")
      return X(w, { [br.Add]() {
  ...
  let I = ou({ name: "DialogDescription", slot: computed(() => ({ open: u.value })) }), E = ref(null), S = { titleId: E, panelRef: ref(null), dialogState: p, setTitleId(w) {
    E.value !== w && (E.value = w);
  }, close() {
    t("close", false);
  } };
  ...
  function y() {
    var w, O, $;
    return [...Array.from((O = (w = d.value) == null ? void 0 : w.querySelectorAll("body > *, [data-headlessui-portal]")) != null ? O : []).filter((T) => !(!(T instanceof HTMLElement) || T.contains(oe(f)) || S.panelRef.value && T.contains(S.panelRef.value))), ($ = S.panelRef.value) != null ? $ : h$1.value];
  }
  return Gl(() => y(), (w, O) => {
    S.close(), nextTick(() => O == null ? void 0 : O.focus());
  }, computed(() => p.value === 0 && !g.value)), Ri((a = d.value) == null ? void 0 : a.defaultView, "keydown", (w) => {
    ...
    let { id: w, open: O, initialFocus: $, ...T } = e, _ = { ...r, ref: h$1, id: w, role: "dialog", "aria-modal": p.value === 0 ? true : void 0, "aria-labelledby": E.value, "aria-describedby": I.value }, D = { open: p.value === 0 };
    return h(yr, { force: true }, () => [h(Ui, () => h(nu, { target: h$1.value }, () => h(yr, { force: false }, () => h(dt, { initialFocus: $, containers: c, features: m.value ? X(A.value, { parent: dt.features.RestoreFocus, leaf: dt.features.All & ~dt.features.FocusLock }) : dt.features.None }, () => z({ ourProps: _, theirProps: T, slot: D, attrs: r, slots: n, visible: p.value === 0, features: Lt.RenderStrategy | Lt.Static, name: "Dialog" }))))), h(gr, { features: jt.Hidden, ref: f })]);
  };
} });
...
let Xi = Lt.RenderStrategy, st = defineComponent({ props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e, { emit: t, attrs: r, slots: n, expose: i }) {
  ...
  let a = ref(null), s = ref("visible"), o = computed(() => e.unmount ? Ee.Unmount : Ee.Hidden);
  i({ el: a, $el: a });
  let { show: l, appear: u } = hu(), { register: c, unregister: h$1 } = mu(), f = { value: true }, d = Ue(), p = { value: false }, m = Ki(() => {
    p.value || (s.value = "hidden", h$1(d), t("afterLeave"));
  });
  onMounted(() => {
    let O = c(d);
    onUnmounted(O);
    ...
    if (o.value === Ee.Hidden && !!d) {
      ...
      X(s.value, { hidden: () => h$1(d), visible: () => c(d) });
    }
  });
  ...
  function w(O) {
    ...
    !T || !(T instanceof HTMLElement) || $ || (p.value = true, l.value && t("beforeEnter"), l.value || t("beforeLeave"), O(l.value ? Fn(T, g, x, A, I, (_) => {
      p.value = false, _ === Sr.Finished && t("afterEnter");
    }) : Fn(T, E, S, y, I, (_) => {
      p.value = false, _ === Sr.Finished && (Xt(m) || (s.value = "hidden", h$1(d), t("afterLeave")));
    })));
  }
  return onMounted(() => {
    watch([l], (O, $, T) => {
  ...
  return onMounted(() => {
    ...
    let c = ki(e, ["show", "appear", "unmount", "onBeforeEnter", "onBeforeLeave", "onAfterEnter", "onAfterLeave"]), h$1 = { unmount: e.unmount };
    return z({ ourProps: { ...h$1, as: "template" }, theirProps: {}, slot: {}, slots: { ...n, default: () => [h(vu, { onBeforeEnter: () => t("beforeEnter"), onAfterEnter: () => t("afterEnter"), onBeforeLeave: () => t("beforeLeave"), onAfterLeave: () => t("afterLeave"), ...r, ...h$1, ...c }, n.default)] }, attrs: {}, features: Xi, visible: s.value === "visible", name: "Transition" });
  };
} });
const gu = {
  props: {
...
function en(e, t, r) {
  var n, i, a, s, o, l, u = 0, c = false, h2 = false, f = true;
  if (typeof e != "function")
    throw new TypeError(qu);
  t = Or(t) || 0, U(r) && (c = !!r.leading, h2 = "maxWait" in r, a = h2 ? Du(Or(r.maxWait) || 0, t) : a, f = "trailing" in r ? !!r.trailing : f);
  function d(y) {
    var w = n, O = i;
  ...
  function g(y) {
    var w = y - l, O = y - u;
    return l === void 0 || w >= t || w < 0 || h2 && O >= a;
  }
  function x() {
    var y = dr();
    if (g(y))
...
function tt(e, t, r) {
  ...
  var s = Ne(e) ? Q(e) : window, o = s.visualViewport, l = !ea() && r, u = (n.left + (l && o ? o.offsetLeft : 0)) / i, c = (n.top + (l && o ? o.offsetTop : 0)) / a, h2 = n.width / i, f = n.height / a;
  return {
    width: h2,
    height: f,
    top: c,
...
function sn(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, i = n === void 0 ? e.placement : n, a = r.strategy, s = a === void 0 ? e.strategy : a, o = r.boundary, l = o === void 0 ? Uu : o, u = r.rootBoundary, c = u === void 0 ? na : u, h2 = r.elementContext, f = h2 === void 0 ? ft : h2, d = r.altBoundary, p = d === void 0 ? false : d, m = r.padding, g = m === void 0 ? 0 : m, x = mc(typeof g != "number" ? g : vc(g, Zt)), A = f === ft ? Wu : ft, I = e.rects.popper, E = e.elements[p ? A : f], S = hc(Ne(E) ? E : E.contextElement || Ce(e.elements.popper), l, c, s), y = tt(e.elements.reference), w = aa({
    reference: y,
    element: I,
    strategy: "absolute",
    placement: i
...
function Nn(e) {
  var t, r = e.popper, n = e.popperRect, i = e.placement, a = e.variation, s = e.offsets, o = e.position, l = e.gpuAcceleration, u = e.adaptive, c = e.roundOffsets, h2 = e.isFixed, f = s.x, d = f === void 0 ? 0 : f, p = s.y, m = p === void 0 ? 0 : p, g = typeof c == "function" ? c({
    x: d,
    y: m
  }) : {
    x: d,
  ...
  if (u) {
    ...
    if (y === Q(r) && (y = Ce(r), ie(y).position !== "static" && o === "absolute" && (w = "scrollHeight", O = "scrollWidth")), y = y, i === re || (i === fe || i === Ie) && a === yt) {
      E = ue;
      var $ = h2 && y === S && S.visualViewport ? S.visualViewport.height : y[w];
      m -= $ - n.height, m *= l ? 1 : -1;
    }
    if (i === fe || (i === re || i === ue) && a === yt) {
      I = Ie;
      var T = h2 && y === S && S.visualViewport ? S.visualViewport.width : y[O];
      d -= T - n.width, d *= l ? 1 : -1;
    }
  }
  var _ = Object.assign({
...
function xc(e) {
  ...
  if (process.env.NODE_ENV !== "production") {
    ...
    s && ["transform", "top", "right", "bottom", "left"].some(function(h2) {
...
function Dc(e) {
  var t = e.state, r = e.options, n = e.name, i = r.mainAxis, a = i === void 0 ? true : i, s = r.altAxis, o = s === void 0 ? false : s, l = r.boundary, u = r.rootBoundary, c = r.altBoundary, h2 = r.padding, f = r.tether, d = f === void 0 ? true : f, p = r.tetherOffset, m = p === void 0 ? 0 : p, g = sn(t, {
    boundary: l,
    rootBoundary: u,
    padding: h2,
    altBoundary: c
...
function Bc(e, t) {
  t === void 0 && (t = {});
  var r = t, n = r.placement, i = r.boundary, a = r.rootBoundary, s = r.padding, o = r.flipVariations, l = r.allowedAutoPlacements, u = l === void 0 ? zu : l, c = nt(n), h2 = c ? o ? kn : kn.filter(function(p) {
    return nt(p) === c;
  }) : Zt, f = h2.filter(function(p) {
    return u.indexOf(p) >= 0;
  });
  f.length === 0 && (f = h2, process.env.NODE_ENV !== "production" && console.error(["Popper: The `allowedAutoPlacements` option did not allow any", "placements. Ensure the `placement` option matches the variation", "of the allowed placements.", 'For example, "auto" cannot be used to allow "bottom-start".', 'Use "auto-start" instead.'].join(" ")));
...
function Rc(e) {
  ...
  if (!t.modifiersData[n]._skip) {
    for (var i = r.mainAxis, a = i === void 0 ? true : i, s = r.altAxis, o = s === void 0 ? true : s, l = r.fallbackPlacements, u = r.padding, c = r.boundary, h2 = r.rootBoundary, f = r.altBoundary, d = r.flipVariations, p = d === void 0 ? true : d, m = r.allowedAutoPlacements, g = t.options.placement, x = pe(g), A = x === g, I = l || (A || !p ? [qt(g)] : Mc(g)), E = [g].concat(I).reduce(function(Ge, be) {
...
function la(e, t, r, n, i, a) {
  ...
  if (u && c)
    return u == t && c == e;
  var h2 = -1, f = true, d = r & od ? new Mt() : void 0;
  for (a.set(e, t), a.set(t, e); ++h2 < o; ) {
    var p = e[h2], m = t[h2];
    if (n)
      var g = s ? n(m, p, h2, t, e, a) : n(p, m, h2, e, t, a);
    if (g !== void 0) {
      if (g)
        continue;
      f = false;
...
function Kd(e, t, r, n, i, a) {
  ...
  if (!(r & zd)) {
    var d = c && ti.call(e, "__wrapped__"), p = h2 && ti.call(t, "__wrapped__");
    if (d || p) {
...
function er(e, t, r, n, i) {
  return e === t ? true : e == null || t == null || !_e(e) && !_e(t) ? e !== e && t !== t : Kd(e, t, r, n, er, i);
}
var Xd = 1, Yd = 2;
function Qd(e, t, r, n) {
  ...
  for (; ++i < a; ) {
    ...
    if (s && o[2]) {
      ...
      var h2 = new he();
      if (n)
        var f = n(u, c, l, e, t, h2);
      if (!(f === void 0 ? er(c, u, Xd | Yd, n, h2) : f))
        return false;
    }
  }
  return true;
    ...
    initFilepond(e) {
      ...
      return new Promise((n) => {
        import("filepond").then((i) => {
          ...
          }, this.server && (a.server.process = (s, o, l, u, c, h2, f) => {
...
function ha(e) {
  return e === true || e === false || _e(e) && Fe(e) == Sf;
}
function ma(e, t) {
  var r = {};
...
const kf = {
  ...
  methods: {
    loadRemoteOptions() {
      !this.remoteUrl || (this.loading = true, Oe({
        url: this.remoteUrl,
        method: "GET",
        headers: {
